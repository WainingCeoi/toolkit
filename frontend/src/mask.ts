...
// - the overlay: what is shown over the image and what the person paints —
//   the theme red at full alpha where masked, fully transparent elsewhere,
//   composited at reduced opacity.
